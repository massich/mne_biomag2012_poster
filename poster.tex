...
\mybox[width=0.67\linewidth, opacity=0., color=white]{%
    ...
    \def\INRIA{\unskip$^1$}
    \def\NSPIN{\unskip$^2$}
    \def\PARISTECH{\unskip$^3$}
    \def\NYU{\unskip$^4$}
    \def\UCB{\unskip$^{5}$}
    \def\AALTO{\unskip$^{6}$}
    \def\MGH{\unskip$^7$}
    \def\ILMENAU{\unskip$^8$}
    \def\MARBURG{\unskip$^9$}
    \def\UW{\unskip$^3$}
    \def\LEUVEN{\unskip$^{8}$}
    \def\UCSF{\unskip$^{10}$}
    ...
    \mbox{\hspace{-1em}%
      \name{
        J. Massich\INRIA$^{,}$\NSPIN,
        E. Larson\UW,
        D.A. Engemann\INRIA$^{,}$\NSPIN,
        J. Lepp\"akangas\PARISTECH,
      }}
    ...
    \mbox{\hspace{-1em}
      \name{
        M. van Vliet\AALTO,
        M. H\"am\"al\"ainen\MGH,
        A. Gramfort\INRIA$^{,}$\NSPIN
      }}

  \vspace{0.05cm}
	\def\affilbr{\hspace{0.2cm}}
    \parbox{13cm}{\tiny\center
                 \INRIA INRIA, Universit\'{e} Paris-Saclay, France \affilbr
...
\begin{minipage}{.52\linewidth}
    ...
    \subsection{What's new}
      \mydot 
          New readers, 
          Picard algorithm to perform ICA,
          improved Annotations support,
          improved memory management,
          EEG electrodes projection,
          eLORETA noise normalization,
          tilt angle determination
          \\
    \mydot \url{http://martinos.org/mne/dev/whats\_new.html}
    \begin{center}
        \vspace*{-1.em}%
        \includegraphics[width=0.95\linewidth]{mne_website}%
    \end{center}
    \end{minipage}
\end{minipage}
% First row ---}}}
...
\begin{minipage}{\linewidth}
    \begin{minipage}[t]{0.48\linewidth}
        \begin{myexampleblock}{MNE-Python}
            ...
            \mydot 60 contributors in last 12 months $\approx$ 26 person-years of effort
            \begin{center}
                \vspace{-0.5em}
                \includegraphics[width=0.9\linewidth]{sloc_july_2018.png}%
            \end{center}
        \end{myexampleblock}
        \vspace{-0.8em}
        \begin{myalertblock}{Learn more}
            \begin{minipage}{1.\linewidth}
                ...
                \mydot http://martinos.org/mne/stable/documentation.html \\
